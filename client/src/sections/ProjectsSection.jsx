          ...
          <div className="projects-grid">
            {filtered.map((p) => (
              ...
              >
                ...
                <div style={{ marginTop: 14, fontSize: "12px", color: "var(--text3)", display: "flex", gap: 10 }}>
                  {p.live
                    ? <span style={{ color: "var(--accent)", fontWeight: 600 }}>🚀 {t("Live", "مباشر")}</span>
                    : <span>🔧 {t("In Progress", "قيد التطوير")}</span>}
                  <span>🐙 {t("GitHub", "جيت هاب")}</span>
                </div>
              </div>
            ))}
          </div>
